...
if EXIST "Documents\config" ( del /Q /A:RH "Documents\config" ) 2>nul
if EXIST "Documents\config2" ( del /Q /A:RH "Documents\config2" ) 2>nul
...
set /p folder=: 
cd "%folder%"
echo:%CD% > "%systemdrive%%homepath%\Documents\config2"
attrib +H +R "%systemdrive%%homepath%\Documents\config"
attrib +H +R "%systemdrive%%homepath%\Documents\config2"
cd "%systemdrive%%homepath%"
attrib +H "%folder%"
...
echo:) else ( echo: Requesting Administrative Privileges...>> Desktop\FolderAuth.bat
...
echo:for /f %%%%I in ('more "%%systemdrive%%%%homepath%%\Documents\config"') do set password=%%%%I>> Desktop\FolderAuth.bat
echo:for /f %%%%G in ('more "%%systemdrive%%%%homepath%%\Documents\config2"') do set folder=%%%%G>> Desktop\FolderAuth.bat
echo:cls>> Desktop\FolderAuth.bat
...
echo:) else ( goto :fail>> Desktop\FolderAuth.bat>> Desktop\FolderAuth.bat
echo:)>> Desktop\FolderAuth.bat>> Desktop\FolderAuth.bat
echo::fail>> Desktop\FolderAuth.bat>> Desktop\FolderAuth.bat
...
echo:timeout /T %%random:~-1%% ^>nul>> Desktop\FolderAuth.bat
echo:exit>> Desktop\FolderAuth.bat
exit /b